...
//     `flex items-center gap-3 px-4 py-2.5 text-sm border-l-2 transition-all group relative ${
//       isActive
...
//           <span className="text-amber-400">📋</span> Dowry Information
//         </NavLink>

//         {/* Chatbot Sidebar Option */}
//         <NavLink to="/chatbot" className={linkClass} title="Chatbot Sidebar Option">
//           <Bot size={15} className="shrink-0" /> AI Chatbot
//         </NavLink>
...
//         <div className="flex items-center gap-2.5 px-2 py-2 rounded-lg bg-gray-800" title="User Profile">
